...
public class AllEventAdapter extends RecyclerView.Adapter<AllEventAdapter.AllEventViewHolder> {
    ...
    public static class AllEventViewHolder extends RecyclerView.ViewHolder {
        ...
        public AllEventViewHolder(View v) {
            super(v);
    ...
    public AllEventAdapter(SecondActivity secondActivity,List<AllEvent> allEvent, int rowLayout, Context context) {
        this.allEvent = allEvent;
        this.rowLayout = rowLayout;
        this.context = context;
        setClickListener(secondActivity);
    }

    @Override
    public AllEventAdapter.AllEventViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new AllEventAdapter.AllEventViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AllEventAdapter.AllEventViewHolder holder, @SuppressLint("RecyclerView") final int position) {
